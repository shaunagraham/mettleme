...
(function() {
  jQuery(function() {
    ...
    return $("#session_password").blur(function() {
      this.type = "password";
      if (this.value === "") {
        this.value = "Password";
      }
...
(function() {
  jQuery(function() {
    $("#message_delete_id").on("click", function() {
      return $("#delete_message_form").submit();
    });
    return $("#check_all_checkall").change(function() {
      if ($(this).is(":checked")) {
        return $(".message_check").each(function() {
...
(function() {
  jQuery(function() {
    $("#search_sunspot").change(function() {
      $("#search").attr("value", $(this).val());
    });
    $("#search_sunspot").keyup(function(e) {
      if (e.keyCode === 13) {
        $("#search_form").submit();
      }
    });
    ...
    return $(".subscriber :checkbox").change(function() {
      var $cs;
