    ...
    Foundation.libs.dropdown = {
        ...
        events: function () {
            ...
            e(this.scope).on("click.fndtn.dropdown", "[data-dropdown]", function (t) {
                ...
                var but = e(t.target).closest(".dropdown");
                $(but).addClass('active_dropdown');
        ...
        close: function (t) {
            ...
            t.each(function () {
                e(this).hasClass(n.settings.activeClass) && (e(this).fadeOut(200).removeClass(n.settings.activeClass), e(this).trigger("closed"))
            })
        },
        open: function (e, t) {
        ...
        css: function (n, r) {
            ...
            } else var s = r.position(); if (this.small()) n.css({
                position: "absolute",
                width: "95%",
                left: "2.5%",
                "max-width": "none",
        ...
        open: function (t, n) {
            if (t)
                if (typeof t.selector != "undefined") var r = e("#" + t.data("reveal-id"));
                    ...
                    var r = e(this.scope);
                    n = t
                } else var r = e(this.scope); if (!r.hasClass("open")) {
...
function (e, t, n, r) {
    ...
    Foundation.libs.section = {
        ...
        position_content: function (t, n) {
            ...
            if (typeof n == "boolean") o.attr("style", ""), t.attr("style", ""), o.css("minHeight", ""), o.css("maxWidth", "");
        ...
        results: function (t, n) {
            ...
            if (r > 0) {
                ...
                for (var o = r - 1; o >= 0; o--) {
                    ...
                    else var a = matchMedia(n[o][2]); if (a.matches) return {
                        el: s,
                        scenario: n[o]
                    }
                }
